...
import unittest
import copy
from parcial import torneo_de_gallinas
...
class Ej1Test(unittest.TestCase):
    ...
    def test_torneo_variado_por_4(self):
        ...
        entrada = {'Juli': NO_ME_DESVIO, 'Facu': NO_ME_DESVIO, 'Lucas': ME_DESVIO, 'Ana': ME_DESVIO}
        entrada_pre = copy.deepcopy(entrada)
