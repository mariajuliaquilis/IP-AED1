import inspect
import unittest
from parcial import alarma_epidemiologica
...
class Ej2Test(unittest.TestCase):
    ...
    def test_caso_base(self):
        ...
        umbral = 0.4
        esperado = {"covid": 0.6}
        esperado_100 = {"covid": 60}
        res = alarma_epidemiologica(registros, infecciosas, umbral)
    ...
    def test_todas_infecciosas_superan_umbral(self):
        ...
        esperado_100 = {"gripe": 50, "covid": 50}
        res = alarma_epidemiologica(registros, infecciosas, umbral)
        self.assertTrue(res == esperado or res == esperado_100)
    ...
    def test_alarma_epidemiologica_4(self):
        ...
        esperado = {"Cólera": 4/9, "Viruela": 1/3}
        esperado_100 = {"Cólera": 4/9 * 100, "Viruela": 1/3 * 100}
